...
const CATEGORIES = [
  ['B', 'Biryani', 'biryani'], ['N', 'North Indian', 'north indian'], ['S', 'South Indian', 'south indian'],
  ['C', 'Chaat & Street', 'chaat'], ['T', 'Tandoor & Kebabs', 'tandoor'], ['H', 'Healthy Bowls', 'healthy'], ['S', 'Artisanal Sweets', 'sweet'],
];
const COLLECTIONS = [
...
export default function Home() {
  ...
  return <main className="home">
    <section className="home-hero"><div className="home-hero-inner"><div className="hero-copy">
      ...
      <form className="hero-search" onSubmit={findFood} role="search"><span className="search-symbol" aria-hidden="true">⌕</span><input value={search} onChange={(e) => setSearch(e.target.value)} placeholder="Search dishes, restaurants, cuisines..." aria-label="Search dishes" /><button className="primary" type="submit">Find Food <span aria-hidden="true">→</span></button></form>
